...
func (_m *Component) ToMap(envName string) (map[string]ast.Node, error) {
	ret := _m.Called(envName)

	var r0 map[string]ast.Node
	if rf, ok := ret.Get(0).(func(string) map[string]ast.Node); ok {
		r0 = rf(envName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]ast.Node)
		}
	}
