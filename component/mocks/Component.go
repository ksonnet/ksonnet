...
// ToMap provides a mock function with given fields: envName
func (_m *Component) ToMap(envName string) (map[string]*astext.Object, error) {
	ret := _m.Called(envName)

	var r0 map[string]*astext.Object
	if rf, ok := ret.Get(0).(func(string) map[string]*astext.Object); ok {
		r0 = rf(envName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[string]*astext.Object)
		}
	}
